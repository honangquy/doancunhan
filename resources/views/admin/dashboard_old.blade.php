    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white shadow-lg min-h-screen sticky top-16">
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('admin.users.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.conferences.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.permissions.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.settings.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.logs.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.reports.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="flex-1 p-6 lg:p-8">
            ...
            <div class="bg-white rounded-xl shadow-md mb-8" x-data="joinRequestManager()">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h2 class="text-xl font-bold text-gray-900">Yêu cầu tham gia chờ duyệt</h2>
                    ...
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Hội thảo</th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Vai trò</th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Ngày gửi</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $request->email_contact }}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $request->conference_title }}</div>
                                    <div class="text-xs text-gray-500">{{ $request->conference_code }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 text-xs font-semibold rounded-full {{ $request->role === 'AUTHOR' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800' }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                    <button @click="processRequest({{ $request->id }}, 'approve')" 
                                            class="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded-lg font-medium transition">
                                        Duyệt
                                    </button>
                                    <button @click="processRequest({{ $request->id }}, 'reject')" 
                                            class="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded-lg font-medium transition">
                                        Từ chối
                                    </button>
                                </td>
                            </tr>
    ...
    function joinRequestManager() {
        return {
            processRequest(requestId, action) {
                ...
                if (!confirm(`Bạn có chắc chắn muốn ${actionText} yêu cầu này?`)) {
                    return;
                }
                
                const notes = prompt(`Ghi chú (tùy chọn):`);
                
                fetch(`/admin/join-requests/${requestId}/process`, {
                    method: 'POST',
                    headers: {
