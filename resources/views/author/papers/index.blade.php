...
<head>
    ...
    <title>Bài báo của tôi - HUIT Conferences</title>
        ...
        <div class="px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('author.dashboard') }}" class="px-4 py-2 hover:bg-blue-700 rounded-lg transition">
                        Dashboard
                    </a>
                    <a href="{{ route('author.papers.index') }}" class="px-4 py-2 bg-blue-900 rounded-lg">
                        Bài báo
                    </a>
                    
                    <!-- User Menu -->
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" class="flex items-center space-x-2 px-4 py-2 hover:bg-blue-700 rounded-lg transition">
                            <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center">
                                <span class="text-sm font-semibold">{{ substr(Auth::user()->full_name, 0, 1) }}</span>
                            </div>
                            <span class="hidden md:inline">{{ Auth::user()->full_name }}</span>
