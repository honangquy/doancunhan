...
<!-- Stats Cards -->
            ...
            <div class="grid md:grid-cols-4 gap-6 mb-8">
                <!-- Card 5: Total Reviewers -->
                <div class="stat-card bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 animate-scaleIn hover:shadow-lg transition-all duration-300" style="animation-delay: 0.5s">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Tổng phân công</p>
                            <h3 class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['total_reviewers'] ?? 0 }}</h3>
                            <p class="text-xs text-purple-600 mt-2">👥 Reviewer assignments</p>
                        </div>
                ...
                <!-- Card 6: Pending Reviewers -->
                <div class="stat-card bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500 animate-scaleIn hover:shadow-lg transition-all duration-300" style="animation-delay: 0.6s">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Chờ chấp nhận</p>
                            <h3 class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['pending_reviewers'] ?? 0 }}</h3>
                            <p class="text-xs text-blue-600 mt-2">⏳ Pending invitations</p>
                        </div>
                        <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                ...
                <!-- Card 7: Active Reviewers -->
                <div class="stat-card bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500 animate-scaleIn hover:shadow-lg transition-all duration-300" style="animation-delay: 0.7s">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Đang làm</p>
                            <h3 class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['active_reviewers'] ?? 0 }}</h3>
                            <p class="text-xs text-green-600 mt-2">✍ Đã chấp nhận</p>
                        </div>
                        <div class="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                            <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Card 8: Completed Reviews -->
                <div class="stat-card bg-white rounded-xl shadow-md p-6 border-l-4 border-teal-500 animate-scaleIn hover:shadow-lg transition-all duration-300" style="animation-delay: 0.8s">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xs text-teal-600 mt-2">✅ Completed reviews</p>
                        </div>
