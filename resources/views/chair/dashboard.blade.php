            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 animate-slideInUp" style="animation-delay: 0.7s">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('chair.conferences.index') }}" class="flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                            ...
                            <div>
                                <h4 class="font-medium text-gray-900">Quản lý kỷ yếu</h4>
                                <p class="text-sm text-gray-500">Xuất bản kỷ yếu hội thảo</p>
                            </div>
                        </a>
                    </div>
                </div>
