                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li x-data="{ conferenceMenuOpen: false }">
                        <button @click="conferenceMenuOpen = !conferenceMenuOpen" 
                            ...
                            <span class="ml-3">Quản lý hội thảo</span>
                        ...
                        <div x-show="conferenceMenuOpen" 
                            ...
                            <a href="{{ route('admin.configured-conferences.index') }}" 
                               class="flex items-center p-2 pl-4 rounded-lg text-sm {{ request()->routeIs('admin.configured-conferences.index') ? 'bg-green-100 text-green-700' : 'text-gray-700 hover:bg-gray-100' }}">
