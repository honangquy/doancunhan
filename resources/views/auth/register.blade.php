           ...
           class="hidden lg:flex w-1/2 relative items-center justify-center overflow-hidden bg-gradient-to-b from-blue-400 via-blue-600 to-blue-900">
            <div class="absolute inset-0 left-rings pointer-events-none">
                <svg viewBox="0 0 1200 800" preserveAspectRatio="xMinYMin meet" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                    ...
                    <g stroke="url(#g2)" stroke-width="6" fill="none">
            ...
            <div class="relative z-10 px-16">
                ...
                <p class="text-white/80 max-w-lg">Tạo tài khoản để tham gia nộp bài và phản biện trực tuyến cho hội thảo.</p>
                <div class="mt-8">
        ...
        <div class="flex-1 flex items-center justify-center px-6 py-12">
            <div class="w-full max-w-md" x-data="{ showForm: false }" x-init="setTimeout(()=> showForm = true, 180)" >
                <div x-show="showForm" x-transition:enter="transition ease-out duration-500"
                    ...
                    <h2 class="text-2xl font-extrabold text-gray-900 mb-2">Chào mừng!</h2>
                    <p class="text-sm text-gray-500 mb-6">Tạo tài khoản mới để bắt đầu</p>
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" required value="{{ old('email') }}" placeholder="Nhập email"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required placeholder="Confirm Password" class="block w-full pl-12 pr-4 py-3 rounded-full border border-gray-200 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-accent-orange focus:border-accent-orange">
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input id="terms" name="terms" type="checkbox" required class="h-4 w-4 text-accent-orange focus:ring-accent-orange border-gray-300 rounded">
                            </div>
                            <div class="ml-3 text-sm">
                                <label for="terms" class="font-medium text-gray-700">Tôi đồng ý với <a href="#" class="text-accent-orange hover:underline">Điều khoản dịch vụ</a> và <a href="#" class="text-accent-orange hover:underline">Chính sách bảo mật</a></label>
                            </div>
                        </div>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">Đã có tài khoản?
                            <a href="{{ route('login') }}" class="font-medium text-blue-600 hover:text-blue-700 transition">Đăng nhập</a>
                        </p>
                    </div>
