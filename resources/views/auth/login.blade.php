                ...
                <div x-show="showForm" x-transition:enter="transition ease-out duration-500"
                    ...
                    <input id="password" name="password" type="password" autocomplete="current-password" required placeholder="Nhập mật khẩu"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="{{ route('password.request') }}" class="font-medium text-blue-600 hover:text-blue-700 transition">Quên mật khẩu?</a>
                            </div>
                        </div>

                        <div>
                            <button type="submit" class="w-full py-3 rounded-full text-white bg-accent-orange hover:bg-amber-600 shadow-md hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">Đăng nhập</button>
                        </div>
                    </form>
